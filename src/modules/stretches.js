...
export const DEFAULT_ROUTINES = [
  {
    id: 'desk-relief',
    name: '上班族肩頸放鬆',
    description: '針對長時間坐在電腦前的上班族所設計。幫助緩解頸部、肩部和上背部因靜止不動而累積的緊繃與酸痛。',
    durationText: '2.5 分鐘',
    steps: [
      {
        id: 'neck-tilt',
      ...
      },
      {
        ...
        ttsCues: [
          { time: 0, text: '現在是站立擴胸。雙手在背後十指互扣，微微伸直雙臂，將胸口向上提起，微微抬起下巴。' },
      ...
      },
      {
        ...
        ttsCues: [
          { time: 0, text: '進行體側伸展。將右手臂高舉過頭，上半身向左傾斜，深呼吸並感受右側肋骨與腰側的延展。' },
      ...
      },
      {
        ...
        ttsCues: [
          { time: 0, text: '最後一個動作，站立前彎。從髖部對折前彎，讓頭部與雙臂放鬆垂下。膝蓋記得保持微彎。' },
  ...
  },
  {
    id: 'bedtime-yoga',
    name: '睡前放鬆伸展',
    description: '結合深呼吸與緩慢的肌肉拉伸，引導大腦與身體釋放整天累積的壓力，為 restful 睡眠做好準備。',
    durationText: '2 分鐘',
    steps: [
      {
        id: 'chest-opener',
        ...
        ttsCues: [
          { time: 0, text: '歡迎來到睡前放鬆伸展。首先是溫和開背。吸氣並將胸腔向前向上提起，溫和延展脊椎。' },
      ...
      },
      {
        ...
        ttsCues: [
          ...
          { time: 15, text: '現在慢慢將頭部換向左側。感覺肩膀和頸部的肌群正在逐漸融化、舒展開來。' },
